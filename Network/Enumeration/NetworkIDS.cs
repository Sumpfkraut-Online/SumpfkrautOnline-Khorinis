...
namespace GUC.Enumeration
{
    ...
    */
    ...
    public enum LoginMessageType : byte
    {
        ...
        GetChars,  //Receive characters' info of the account
        CreateChar,//Create a new character on the account
        LoginChar, //Spawn with this character in the world        
        Failed //Wrong accountname / password
    }
    ...
    public enum BodyMesh : byte
    {
        HUM_BODY_NAKED0,
        HUM_BODY_BABE0
    }

    public enum HeadMesh : byte
    {
        HUM_HEAD_BALD,
        HUM_HEAD_FATBALD,
        HUM_HEAD_FIGHTER,
