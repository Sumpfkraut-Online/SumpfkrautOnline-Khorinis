...
namespace GUC.Scripts.Sumpfkraut.EffectSystem.EffectHandlers
{
    ...
    public class ItemDefEffectHandler : VobDefEffectHandler
    {

        new public static readonly string _staticName = "ItemDefEffectHandler (static)";
        ...
        public ItemDefEffectHandler (List<Effect> effects)
            : this("ItemDefEffectHandler (default)", effects)
        { }

        public ItemDefEffectHandler (string objName, List<Effect> effects) 
