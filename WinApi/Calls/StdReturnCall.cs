...
{
    public class StdReturnCall<TReturn> : AbstractCall
    {
        ...
        public StdReturnCall(int address) : base(address)
        {
            this.call = GetDelegateFromFunction<CallHandler>(address);
        }
    }

    public class StdReturnCall<TReturn, T> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    ...
    public class StdReturnCall<TReturn, T0, T1> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    ...
    public class StdReturnCall<TReturn, T0, T1, T2> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    ...
    public class StdReturnCall<TReturn, T0, T1, T2, T3> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    ...
    public class StdReturnCall<TReturn, T0, T1, T2, T3, T4> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    ...
    public class StdReturnCall<TReturn, T0, T1, T2, T3, T4, T5> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    ...
    public class StdReturnCall<TReturn, T0, T1, T2, T3, T4, T5, T6> : AbstractCall
    {
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
