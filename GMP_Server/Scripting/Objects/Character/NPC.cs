...
namespace GUC.Server.Scripting.Objects.Character
{
    ...
    */
    public class NPC : Vob
    {
        ...
        protected NPC() : base(new GUC.WorldObjects.Character.NPC())
        {
            this.proto.ScriptingNPC = this;
        }

        internal NPC(GUC.WorldObjects.Character.NPC proto) : base(proto)
        {
        ...
        {
            /*if (ProtoNPC.client == null)
            {
                throw new Exception("NPC is not a Player!");
            }*/
            return (Player)this;
        }

        public bool NPCControlled { get { return (proto.npcController != null); } }
        ...
        internal GUC.WorldObjects.Character.NPC proto { get { return (GUC.WorldObjects.Character.NPC)vob; } }
        ...
        public void setAttribute(NPCAttribute attrib, int value)
        {
            ...
            NPC.isOnAttributeChanged(this, attrib, oV, value);
        ...
        public void setHitchances(NPCTalent talents, int value)
        {
            ...
            NPC.isOnHitchancesChanged(this, talents, oV, value);
        ...
        public void setTalentValues(NPCTalent talent, int value)
        {
            ...
            NPC.isOnTalentValueChanged(this, talent, oV, value);
        ...
        public void setTalentSkills(NPCTalent talent, int value)
        {
            ...
            NPC.isOnTalentSkillChanged(this, talent, oV, value);
        ...
        public void hit(NPC victim)
        {
            hit(victim, DamageTypes.DAM_BLUNT, 0, this.proto.Weapon.ScriptingProto, null, null, null, 0.0f);
        }

        public void hit(NPC victim, DamageTypes damageMode)
        {
            hit(victim, damageMode, 0, this.proto.Weapon.ScriptingProto, null, null, null, 0.0f);
        }

        public void hit(NPC victim, DamageTypes damageMode, int weaponMode)
        {
            hit(victim, damageMode, weaponMode, this.proto.Weapon.ScriptingProto, null, null, null, 0.0f);
        }

        public void hit(NPC victim, DamageTypes damageMode, int weaponMode, Vec3f hitLoc)
        {
            hit(victim, damageMode, weaponMode, this.proto.Weapon.ScriptingProto, null, hitLoc, null, 0.0f);
        }

        public void hit(NPC victim, DamageTypes damageMode, int weaponMode, Item weapon, Vec3f hitLoc)
        {
            hit(victim, damageMode, weaponMode, weapon, null, hitLoc, null, 0.0f);
        }

        public void hit(NPC victim, DamageTypes damageMode, int weaponMode, Item weapon, Spell spell, Vec3f hitLoc)
        {
            hit(victim, damageMode, weaponMode, weapon, spell, hitLoc, null, 0.0f);
        }

        public void hit(NPC victim, DamageTypes damageMode, int weaponMode, Item weapon, Spell spell, Vec3f hitLoc, Vec3f flyDir, float fallDownDistanceY)
        {
            ...
            NPC.isOnDamage(victim, (DamageTypes)damageMode, hitLoc, flyDir, this, weaponMode, spell, weapon, fallDownDistanceY);
        ...
        internal void iOnCanSee(int callbackID, NPC proto, Vob vob, bool canSee)
        {
            if (OnCanSee != null)
        ...
        internal static void iOnCanSeeCallback(int callbackID, NPC proto, Vob vob, bool canSee)
        {
        ...
        internal void iOnAnimation(NPC proto, short animID, short oldAnimID)
        {
            if (OnAnimation != null)
        ...
        internal static void isOnAnimation(NPC proto, short animID, short oldAnimID)
        {
        ...
        internal static void isOnEquip(NPC proto, Item item)
        {
        ...
        internal static void isOnUnEquip(NPC proto, Item item)
        {
        ...
        internal void iOnUseItem(NPC proto, Item item, short state, short targetState)
        {
            if (OnUseItem != null)
        ...
        internal static void isOnUseItem(NPC proto, Item item, short state, short targetState)
        {
        ...
        internal static void isOnCastSpell(NPC caster, Spell spell, Vob target)
        {
        ...
        internal void iOnAttributeChanged(NPC proto, NPCAttribute attrib, int oldValue, int newValue)
        {
        ...
        internal static void isOnAttributeChanged(NPC proto, NPCAttribute attrib, int oldValue, int newValue)
        {
        ...
        internal void iOnTalentValueChanged(NPC proto, NPCTalent talent, int oldValue, int newValue)
        {
        ...
        internal static void isOnTalentValueChanged(NPC proto, NPCTalent talent, int oldValue, int newValue)
        {
        ...
        internal void iOnTalentSkillChanged(NPC proto, NPCTalent talent, int oldValue, int newValue)
        {
        ...
        internal static void isOnTalentSkillChanged(NPC proto, NPCTalent talent, int oldValue, int newValue)
        {
        ...
        internal void iOnHitchancesChanged(NPC proto, NPCTalent talent, int oldValue, int newValue)
        {
        ...
        internal static void isOnHitchancesChanged(NPC proto, NPCTalent talent, int oldValue, int newValue)
        {
        ...
        internal void iOnDamage(NPC victim, DamageTypes damageMode, Vec3f hitLoc, Vec3f flyDir, Vob attacker, int weaponMode, Spell spellID, Item weapon, float fallDownDistanceY)
        {
            if (OnDamage != null)
        ...
        internal static void isOnDamage(NPC victim, DamageTypes damageMode, Vec3f hitLoc, Vec3f flyDir, Vob attacker, int weaponMode, Spell spellID, Item weapon, float fallDownDistanceY)
        {
        ...
        internal void iOnTakeItem(NPC npc, Item item, int amount)
        {
            if (OnTakeItem != null)
        ...
        internal static void OnItemTakes(NPC npc, Item item, int amount)
        {
        ...
        internal void iOnDropItem(NPC npc, Item item, int amount)
        {
            if (OnDropItem != null)
        ...
        internal static void isOnDropItem(NPC npc, Item item, int amount)
        {
