...
namespace GUC.Client.Menus.MainMenus
{
    class CharCreationMenu : GUCMainMenu
    {
        ...
        protected override void OnCreate()
        {
            ...
            Character.Info.BodyMesh = (int)HumBodyMesh.HUM_BODY_BABE0;
        ...
        {
            AccCharInfo info = Character.Info;
            if (bodymesh.Choice == (int)HumBodyMesh.HUM_BODY_NAKED0)
            {
        ...
        { 
            { (int)HumBodyMesh.HUM_BODY_NAKED0, "männlich" }, 
            { (int)HumBodyMesh.HUM_BODY_BABE0, "weiblich" } 
        };
        ...
        { 
            {(int)HumHeadMesh.HUM_HEAD_BALD, "Ulu" },
            {(int)HumHeadMesh.HUM_HEAD_FATBALD, "Mulu" },
            {(int)HumHeadMesh.HUM_HEAD_FIGHTER, "hoch" },
            {(int)HumHeadMesh.HUM_HEAD_PONY, "mit Zopf" },
            {(int)HumHeadMesh.HUM_HEAD_PSIONIC, "spitz" }, 
            {(int)HumHeadMesh.HUM_HEAD_THIEF, "mit Zopf2" }
        };

        static Dictionary<int, string> c_HeadMeshes_F = new Dictionary<int, string>() 
        { 
            {(int)HumHeadMesh.HUM_HEAD_BABE, "Fremder" },
            {(int)HumHeadMesh.HUM_HEAD_BABE1, "tragen" },
            {(int)HumHeadMesh.HUM_HEAD_BABE2, "Ulu" },
            {(int)HumHeadMesh.HUM_HEAD_BABE3, "Mulu" },
            {(int)HumHeadMesh.HUM_HEAD_BABE4, "," },
            {(int)HumHeadMesh.HUM_HEAD_BABE5, "dann" },
            {(int)HumHeadMesh.HUM_HEAD_BABE6, "Fremder" },
            {(int)HumHeadMesh.HUM_HEAD_BABE7, "nicht" },
            {(int)HumHeadMesh.HUM_HEAD_BABE8, "sterben" },
            {(int)HumHeadMesh.HUM_HEAD_BABEHAIR, "!" } 
        };
