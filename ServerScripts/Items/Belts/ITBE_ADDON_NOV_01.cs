...
{
    public class ITBE_ADDON_NOV_01 : AbstractBelts
    {
        static ITBE_ADDON_NOV_01 ii;
        public static ITBE_ADDON_NOV_01 get()
        {
            if (ii == null)
                ii = new ITBE_ADDON_NOV_01();
            return ii;
        }


        protected ITBE_ADDON_NOV_01()
            : base("ITBE_ADDON_NOV_01")
        {
