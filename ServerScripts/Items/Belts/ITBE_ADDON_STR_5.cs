...
{
    public class ITBE_ADDON_STR_5 : AbstractBelts
    {
        static ITBE_ADDON_STR_5 ii;
        public static ITBE_ADDON_STR_5 get()
        {
            if (ii == null)
                ii = new ITBE_ADDON_STR_5();
            return ii;
        }


        protected ITBE_ADDON_STR_5()
            : base("ITBE_ADDON_STR_5")
        {
