...
{
    public class ITBE_ADDON_MIL_01 : AbstractBelts
    {
        static ITBE_ADDON_MIL_01 ii;
        public static ITBE_ADDON_MIL_01 get()
        {
            if (ii == null)
                ii = new ITBE_ADDON_MIL_01();
            return ii;
        }


        protected ITBE_ADDON_MIL_01()
            : base("ITBE_ADDON_MIL_01")
        {
