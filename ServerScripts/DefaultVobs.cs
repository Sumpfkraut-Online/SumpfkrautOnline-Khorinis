...
namespace GUC.Server.Scripts
{
	public class DefaultVobs
	{
		public static void Init()
		{
			...
			mi = new MobInter("PAN_OC.MDS", "", DefaultItems.ItemInstances["ITFOMUTTONRAW"], null, true, false); 
			...
			mi = new MobInter("BSCOOL_OC.MDS", "MOBNAME_BUCKET", DefaultItems.ItemInstances["ITMISWORDBLADEHOT"], null, true, true); 
			...
			mi = new MobInter("STOVE_NW_CITY_01.ASC", "MOBNAME_STOVE", DefaultItems.ItemInstances["ITFOMUTTONRAW"], null, true, true); 
			mi.Spawn(mapName, new Vec3f(2268.164f, -188.259f, 347.4416f), new Vec3f(0.9999995f, 0f, 2.402812E-07f));

			mi = new MobInter("REPAIR_PLANK.ASC", "", DefaultItems.ItemInstances["ITMI_HAMMER"], null, false, false); 
			mi.Spawn(mapName, new Vec3f(3168.608f, -90.54131f, 565.3643f), new Vec3f(-0.3090172f, 0f, 0.951057f));

			mi = new MobInter("HERB_NW_MISC_01.ASC", "MOBNAME_WINEMAKER", DefaultItems.ItemInstances["ITMI_STOMPER"], null, true, false); 
			...
			mi = new MobInter("BSCOOL_OC.MDS", "MOBNAME_BUCKET", DefaultItems.ItemInstances["ITMISWORDBLADEHOT"], null, true, false); 
			...
			mi = new MobInter("LAB_PSI.ASC", "MOBNAME_LAB", DefaultItems.ItemInstances["ITMI_FLASK"], null, true, false); 
			mi.Spawn(mapName, new Vec3f(6356.664f, 124.4691f, -223.1976f), new Vec3f(-0.9961963f, 0f, 0.08715586f));

			mi = new MobInter("BSSHARP_OC.MDS", "MOBNAME_GRINDSTONE", DefaultItems.ItemInstances["ITMISWORDBLADE"], null, false, false); 
			mi.Spawn(mapName, new Vec3f(5639.21f, 275.0764f, -1663.667f), new Vec3f(-0.5446385f, 0f, -0.8386701f));

			mi = new MobInter("BSFIRE_OC.MDS", "MOBNAME_FORGE", DefaultItems.ItemInstances["ITMISWORDRAW"], null, true, false); 
			...
			mi = new MobInter("BSANVIL_OC.MDS", "MOBNAME_ANVIL", DefaultItems.ItemInstances["ITMISWORDRAWHOT"], null, true, false); 
			...
			mi = new MobInter("BAUMSAEGE_1.ASC", "MOBNAME_SAW", DefaultItems.ItemInstances["ITMI_SAW"], null, true, false); 
			...
			mi = new MobInter("CAULDRON_OC.ASC", "MOBNAME_CAULDRON", DefaultItems.ItemInstances["ITMI_SCOOP"], null, false, false); 
			...
			mi = new MobInter("BSFIRE_OC.MDS", "MOBNAME_FORGE", DefaultItems.ItemInstances["ITMISWORDRAW"], null, false, false); 
			...
			mi = new MobInter("BSFIRE_OC.MDS", "MOBNAME_FORGE", DefaultItems.ItemInstances["ITMISWORDRAW"], null, true, true); 
			mi.Spawn(mapName, new Vec3f(6574.802f, 742.0159f, 6188.446f), new Vec3f(0.4539908f, 0f, -0.8910074f));

			mi = new MobInter("BSSHARP_OC.MDS", "MOBNAME_GRINDSTONE", DefaultItems.ItemInstances["ITMISWORDBLADE"], null, true, true); 
			mi.Spawn(mapName, new Vec3f(6137.359f, 755.0159f, 6368.503f), new Vec3f(0.2588191f, 0f, 0.965926f));

			mi = new MobInter("BSANVIL_OC.MDS", "MOBNAME_ANVIL", DefaultItems.ItemInstances["ITMISWORDRAWHOT"], null, true, true); 
			...
			mi = new MobInter("LAB_PSI.ASC", "MOBNAME_LAB", DefaultItems.ItemInstances["ITMI_FLASK"], null, true, true); 
			...
			mi = new MobInter("PAN_OC.MDS", "MOBNAME_PAN", DefaultItems.ItemInstances["ITFOMUTTONRAW"], null, true, true); 
			...
			mi = new MobInter("CAULDRON_OC.ASC", "MOBNAME_CAULDRON", DefaultItems.ItemInstances["ITMI_SCOOP"], null, true, true); 
			...
			mi = new MobInter("STOVE_NW_CITY_01.ASC", "MOBNAME_STOVE", DefaultItems.ItemInstances["ITFOMUTTONRAW"], null, true, false); 
			...
			mi = new MobInter("TREASURE_ADDON_01.ASC", "", DefaultItems.ItemInstances["ITMW_2H_AXE_L_01"], null, false, false); 
			...
			mi = new MobInter("REPAIR_PLANK.ASC", "MOBNAME_REPAIR", DefaultItems.ItemInstances["ITMI_HAMMER"], null, true, true); 
			...
			mi = new MobInter("BAUMSAEGE_1.ASC", "MOBNAME_SAW", DefaultItems.ItemInstances["ITMI_SAW"], null, true, true); 
			...
			mi = new MobInter("RMAKER_1.MDS", "MOBNAME_RUNEMAKER", DefaultItems.ItemInstances["ITMI_RUNEBLANK"], null, true, false); 
			...
			mi = new MobInter("HERB_NW_MISC_01.ASC", "MOBNAME_WINEMAKER", DefaultItems.ItemInstances["ITMI_STOMPER"], null, true, true); 
			...
			mi = new MobInter("RMAKER_1.MDS", "MOBNAME_RUNEMAKER", DefaultItems.ItemInstances["ITMI_RUNEBLANK"], null, true, true); 
			...
			mi = new MobInter("TOUCHPLATE_STONE.MDS", "MOBNAME_DOOR", DefaultItems.ItemInstances["ITKE_PORTALTEMPELWALKTHROUGH_ADDON"], "EVT_NW_TROLLAREA_TEMPELDOOR_MASTER_01", true, false); 
			mi.Spawn(mapName, new Vec3f(82508.48f, 3462.952f, 23365.96f), new Vec3f(-0.01745219f, 0f, -0.9998483f));

			mi = new MobInter("TOUCHPLATE_STONE.MDS", "", DefaultItems.ItemInstances["ITMI_PORTALRING_ADDON"], "EVT_ADDON_TROLLPORTAL_GAME_EVENT_START_01", true, false); 
			...
			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{250, 5},true, null, "RLLRRLLLRRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(682.9697f, -426.3414f, 24026.74f), new Vec3f(0.4574393f, 0.2249511f, 0.8603178f));

			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_AXE"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_BACON"]},new int[]{26, 1, 1, 1},true, null, "RLLRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-2327.38f, -358.8218f, 20525.63f), new Vec3f(-0.6020718f, 0.229194f, -0.7648402f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUM.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{32},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-2841.872f, -442.1248f, 12826.73f), new Vec3f(-0.9781476f, 0f, -0.2079116f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUM.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITWR_STONEPLATECOMMON_ADDON"], DefaultItems.ItemInstances["ITMI_PITCH"], DefaultItems.ItemInstances["ITFO_CHEESE"]},new int[]{17, 1, 1, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-3224.33f, -422.2288f, 11208.11f), new Vec3f(0.806656f, 0.1549121f, 0.5703575f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMW_1H_VLK_SWORD"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{2, 1, 1, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(1573.009f, -181.6234f, -2755.593f), new Vec3f(0.7660446f, 0f, -0.6427876f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_BLOODCUP_MIS"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 150},true, DefaultItems.ItemInstances["ITKE_BUERGER"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(11559.29f, 899.5332f, 3521.911f), new Vec3f(-0.8987944f, 0f, -0.4383712f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_BOLT"]},new int[]{50},true, null, "RLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(6007.365f, 750.996f, 9204.42f), new Vec3f(0.8480488f, 0f, 0.5299197f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_FISH"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 2, 75},true, null, "RLLRRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(5761.686f, 750.5546f, 6636.632f), new Vec3f(0.9135455f, 0f, -0.4067365f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_CITY_TOWER_06"], DefaultItems.ItemInstances["ITMI_MARIASGOLDPLATE"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 50},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(2613.417f, 750.5546f, 7108.611f), new Vec3f(0.358368f, 0f, 0.9335807f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{50},true, null, "RLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(2833.434f, 750.5546f, 6695.861f), new Vec3f(0.3907323f, 0f, -0.9205073f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_CORAGONSSILBER"], DefaultItems.ItemInstances["ITRW_BOW_L_03_MIS"]},new int[]{8, 1},true, null, "RRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(2510.319f, -641.9491f, 6589.773f), new Vec3f(-0.06275089f, 0f, -0.9980291f));

			mi = new MobContainer("CHESTBIG_NW_RICH_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITAR_VLK_H"], DefaultItems.ItemInstances["ITAR_VLK_M"], DefaultItems.ItemInstances["ITAR_VLK_L"], DefaultItems.ItemInstances["ITFO_SAUSAGE"], DefaultItems.ItemInstances["ITMI_FLASK"]},new int[]{1, 3, 5, 15, 10},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(5660.43f, 261.868f, -5692.02f), new Vec3f(0.8178486f, 0.01736571f, -0.5751721f));

			mi = new MobContainer("CHESTBIG_NW_RICH_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_PLIERS"], DefaultItems.ItemInstances["ITMI_HAMMER"], DefaultItems.ItemInstances["ITLSTORCH"], DefaultItems.ItemInstances["ITAR_LEATHER_L"]},new int[]{3, 5, 15, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(5573.449f, 268.868f, -6033.792f), new Vec3f(0.5446054f, 0f, 0.838692f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRI_PROT_POINT_01_MIS"]},new int[]{20, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(6612.918f, 122.0018f, 28.72816f), new Vec3f(0.5446727f, 0f, -0.8386492f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{36, 1, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(6107.376f, 268.1922f, -157.9734f), new Vec3f(-0.8660059f, 0f, -0.5000346f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_SULFUR"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{2, 1},true, null, "LL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(4042.534f, -113.741f, -6830.253f), new Vec3f(-0.9817718f, 0f, -0.1900802f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{3},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(4621.383f, -115.851f, -3451.401f), new Vec3f(-0.4067004f, 0f, -0.9135613f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"]},new int[]{5},true, DefaultItems.ItemInstances["ITKE_STORAGE"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(2586.069f, 110.2284f, 2492.737f), new Vec3f(-0.06975637f, 0f, 0.9975643f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_HERBPAKET"]},new int[]{1},true, DefaultItems.ItemInstances["ITKE_STORAGE"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3160.189f, 110.8121f, 2693.969f), new Vec3f(0.2249511f, 0f, 0.9743701f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{2, 1},true, null, "LRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(817.9002f, -187.134f, -5529.48f), new Vec3f(-0.8299153f, 0.02328978f, -0.5574083f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{1, 1},true, null, "RLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(871.4547f, -188.8853f, -5318.052f), new Vec3f(0.7277411f, -0.003188853f, 0.6858459f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_SULFUR"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{2, 1},true, null, "LLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(2669.192f, -187.8879f, -4953.99f), new Vec3f(-0.4838389f, 0.00268502f, -0.8751523f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{3, 1},false, null, "RRR", null, null, true, true); 
			...
			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"], DefaultItems.ItemInstances["ITFO_STEW"]},new int[]{1, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3166.694f, -184.0383f, -909.3986f), new Vec3f(0.01150694f, -0.001476236f, 0.9999298f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_APPLE"], DefaultItems.ItemInstances["ITFO_STEW"]},new int[]{10, 3, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3394.079f, -186.267f, 1494.399f), new Vec3f(0.004077423f, 0f, -0.9999917f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{4, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(4604.301f, -187.4268f, 243.1912f), new Vec3f(-0.4845489f, 0.03489953f, 0.8740678f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{3},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3188.372f, -114.5099f, -3590.447f), new Vec3f(0.857146f, 0f, 0.5150716f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{3, 7},true, null, "RL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3529.466f, -191.0055f, 1953.687f), new Vec3f(-0.9411236f, 0.1372427f, -0.3089546f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITPO_MANA_02"]},new int[]{42, 13, 2},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(8267.586f, 271.4124f, -2799.094f), new Vec3f(-0.866008f, 0f, -0.5000359f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{32},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(7654.307f, 126.2051f, 1238.297f), new Vec3f(0.9135287f, 0f, 0.406773f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{25, 25, 1, 1, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(7086.85f, 269.0717f, -2130.404f), new Vec3f(0.4226543f, 0f, -0.906291f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{3, 4, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(6412.64f, 267.5302f, -5302.119f), new Vec3f(-0.1045683f, 0f, 0.9945181f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{41, 1, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(5625.557f, 269.909f, -4159.813f), new Vec3f(0.249405f, 0f, -0.9684001f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITSC_ICEBOLT"], DefaultItems.ItemInstances["ITSC_CHARM"], DefaultItems.ItemInstances["ITSC_SLEEP"], DefaultItems.ItemInstances["ITSC_LIGHT"]},new int[]{50, 1, 1, 2, 2, 1},true, null, "LRRLRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(8223.502f, 268.954f, 3600.449f), new Vec3f(0.9902633f, 0f, 0.1392129f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITSC_CHARGEFIREBALL"], DefaultItems.ItemInstances["ITSC_LIGHTHEAL"], DefaultItems.ItemInstances["ITSC_INSTANTFIREBALL"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 2, 100},true, null, "LRLLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(7432.637f, -642.8083f, 5009.127f), new Vec3f(0.3007444f, 0f, -0.9537067f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{50},true, null, "RRRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(10017.85f, -642.1121f, 3071.128f), new Vec3f(-0.8048728f, 0f, -0.5934525f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 100},true, null, "LLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(10039.48f, -639.5757f, 2876.737f), new Vec3f(-0.9999629f, 0f, 0.008687093f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{25, 25, 75},true, null, "LRRRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(9066.751f, -641.8978f, 2152.418f), new Vec3f(0.725347f, 0f, 0.6883829f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{100},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(10548.31f, 899.5892f, -3311.969f), new Vec3f(-0.7193696f, 0f, 0.6946319f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_BLOODCUP_MIS"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 100},true, null, "RRLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(12360.44f, 1299.009f, -4544.752f), new Vec3f(-0.9986297f, 0f, -0.05237529f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{50},true, null, "LLRRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(12834.18f, 1299.445f, -4820.873f), new Vec3f(0.06971753f, 0f, 0.9975682f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITPO_MANA_01"]},new int[]{50, 30, 1},true, null, "LRRLRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(15290.21f, 900.3315f, -4106.856f), new Vec3f(-0.8571884f, 0f, 0.5150047f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITPO_HEALTH_02"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{3, 2, 50},true, DefaultItems.ItemInstances["ITKE_PALADINTRUHE"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(14854.95f, 1326.607f, -4797.214f), new Vec3f(-0.3090544f, 0f, 0.9510451f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITWR_MAP_NEWWORLD"]},new int[]{25, 1},true, null, "LLRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(1519.275f, -194.4613f, 92.10081f), new Vec3f(-0.9693002f, 0f, -0.2458755f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFOMUTTON"]},new int[]{5, 70, 5},true, null, "RLLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(11069.57f, 265.0967f, 5327.329f), new Vec3f(-0.8746195f, 0f, -0.4848094f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{2, 3, 70},true, null, "RLLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(7413.851f, 266.0967f, -6397.586f), new Vec3f(-0.5299204f, 0f, 0.8480495f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_BLOODCUP_MIS"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 31, 13, 1, 1, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3488.674f, -115.1453f, -2151.905f), new Vec3f(-0.8829294f, 0f, -0.4695068f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_BLOODCUP_MIS"], DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 3, 1, 1, 72},true, DefaultItems.ItemInstances["ITKE_RICHTER"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(16313.37f, 900.5078f, -3030.249f), new Vec3f(0.9902698f, 0f, -0.1391737f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_02"], DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 1, 50},true, DefaultItems.ItemInstances["ITKE_SALANDRIL"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(12695.19f, 897.6389f, 2804.033f), new Vec3f(0.309017f, 0f, 0.9510567f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{50},true, null, "RRRRRRRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(15705.56f, 1538.99f, 155.8144f), new Vec3f(0.1218694f, 0f, -0.9925458f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_PALADINTRUHE"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{1, 1},true, null, "RLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(13950.96f, 1328.767f, -3055.779f), new Vec3f(-0.4539918f, 0f, -0.8910088f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_GOLDCUP"]},new int[]{150, 1},true, null, "RLLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-18826.35f, -339.9137f, 4706.103f), new Vec3f(-0.4999998f, 0f, -0.8660251f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_INNOSSTATUE"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 100},true, null, "RLLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-18628.91f, -338.3015f, 4582.442f), new Vec3f(-0.8660254f, 0f, -0.4999998f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_GOLDCHALICE"], DefaultItems.ItemInstances["ITMI_GOLDCHEST"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{2, 1, 1, 400},true, DefaultItems.ItemInstances["ITKE_THIEFTREASURE"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-18672.35f, -328.3015f, 4144.645f), new Vec3f(-0.1564344f, 0f, 0.9876879f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{100},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-18821.24f, -343.3015f, 4409.59f), new Vec3f(-0.9945219f, 0f, -0.1045283f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_PERM_DEX"], DefaultItems.ItemInstances["ITAM_STRG_01"], DefaultItems.ItemInstances["ITMI_GOLDCUP"], DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 1, 5, 300},true, null, "RRRLRRRLRLRLRRLLLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(6415.869f, -639.8768f, 4665.741f), new Vec3f(-0.7313544f, 0f, -0.6819987f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_BLOODCUP_MIS"], DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 150},true, DefaultItems.ItemInstances["ITKE_VALENTINO"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(11844.59f, 899.4477f, -4136.909f), new Vec3f(0.7431719f, 0f, -0.6691024f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_SILVERPLATE"], DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{2, 1, 100},true, null, "RLRRRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(2339.62f, -177.1674f, -3001.217f), new Vec3f(-0.9848076f, 0f, -0.1736481f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "Chest", new ItemInstance[]{DefaultItems.ItemInstances["ITAR_BAU_L"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_CHEESE"], DefaultItems.ItemInstances["ITFO_APPLE"]},new int[]{1, 2, 1, 2},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(14056.03f, 1591.758f, -13911.69f), new Vec3f(-0.04318183f, -0.0008421556f, 0.9990717f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{20},false, null, "LRRL", null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(5283.209f, 420.6029f, -23775.72f), new Vec3f(0.2465226f, 0.06201322f, 0.9671561f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_AXE"], DefaultItems.ItemInstances["ITFO_BACON"]},new int[]{2, 17, 4, 1, 1},true, null, "RLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-1642.609f, 553.5197f, -9346.222f), new Vec3f(-0.642788f, 0f, 0.766045f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_RUNEBLANK"]},new int[]{1},true, DefaultItems.ItemInstances["ITKE_RUNE_MIS"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(31946.08f, 3088.209f, -779.5698f), new Vec3f(0f, 0f, 1f));

			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_BOW_M_01"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{1, 36, 5},true, null, "RLLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(26788.88f, 4404.663f, -4144.01f), new Vec3f(0.3201032f, -0.1391519f, 0.9371079f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{3, 13, 1},true, null, "LRLLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(31954.01f, 3111.244f, -326.0641f), new Vec3f(-0.06975649f, 0f, -0.9975637f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{3, 31, 23, 23, 1},true, null, "LRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(20624.13f, 817.6805f, 4820.414f), new Vec3f(0.7071072f, 0f, 0.7071074f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{54, 3},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(30382.18f, 3146.305f, 29846.89f), new Vec3f(-0.1736481f, 0f, -0.9848074f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_PITCH"]},new int[]{350, 1},true, null, "RRLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(30263.65f, 3146.305f, 29876.08f), new Vec3f(-0.642787f, 0f, -0.7660434f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_FISH"], DefaultItems.ItemInstances["ITFO_SMELLYFISH"]},new int[]{10, 3, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(3201.645f, 98.92307f, 16448.55f), new Vec3f(0.636488f, 0f, -0.7712862f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMW_1H_VLK_SWORD"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{5, 1, 1, 1},false, null, "RLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(-1763.489f, 2407.624f, 16387.08f), new Vec3f(0.8571681f, 0f, 0.5150385f));

			mi = new MobContainer("CHESTBIG_NW_RICH_OPEN.MDS", "CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_CHEESE"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{2, 3, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(31523.58f, 3440.328f, 8715.939f), new Vec3f(-0.9945256f, 1.129873E-08f, 0.1044886f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_FISH"], DefaultItems.ItemInstances["ITFO_HALVORFISH_MIS"]},new int[]{25, 3, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(15260.08f, 2874.005f, 11226.21f), new Vec3f(0.936858f, 0f, -0.3497091f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{1, 10, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(37691f, 3826.921f, -2740.775f), new Vec3f(-0.03263185f, 0.004166675f, 0.9994625f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_STEW"], DefaultItems.ItemInstances["ITFO_SAUSAGE"], DefaultItems.ItemInstances["ITFO_MILK"], DefaultItems.ItemInstances["ITFO_BEER"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{3, 2, 3, 5, 32},false, null, "RLLRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(38360.72f, 3821.717f, -2687.377f), new Vec3f(-0.9205216f, 0f, 0.390695f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1},true, null, "LL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(37020.46f, 4103.128f, -2728.416f), new Vec3f(0f, 0f, 1f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_SLD_AXE"], DefaultItems.ItemInstances["ITMI_PITCH"], DefaultItems.ItemInstances["ITFO_CHEESE"]},new int[]{17, 1, 1, 1},true, null, "RRLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(37141.45f, 4103.128f, -1975.59f), new Vec3f(-0.9848072f, 0f, -0.173648f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMW_1H_VLK_SWORD"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{2, 1, 1, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(36792.15f, 4109.55f, -1882.401f), new Vec3f(1.062691E-07f, 0f, -0.9999993f));

			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{20, 17},true, null, "RLLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(30217.9f, 4201.882f, -1348.192f), new Vec3f(0.9848071f, 0f, 0.1736482f));

			mi = new MobContainer("CHESTSMALL_OCCHESTSMALLLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ADDON_FIREARROW"]},new int[]{17},true, null, "LRRLLLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(67889.05f, 5520.293f, -21125.88f), new Vec3f(0.8090169f, 0f, -0.5877854f));

			mi = new MobContainer("CHESTSMALL_OCCHESTSMALL.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{12, 22},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(44218.95f, 2905.686f, 2129.868f), new Vec3f(-0.3746057f, 0f, 0.9271812f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{16, 15},true, null, "LRLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(66858.81f, 2484.566f, -22364.13f), new Vec3f(0.9396925f, 0f, 0.3420201f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITPO_HEALTH_02"], DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITMI_QUARTZ"]},new int[]{101, 43, 3, 2, 2},true, DefaultItems.ItemInstances["ITKE_EVT_CRYPT_02"], null, null, "EVT_CRYPT_02_TRIGGER", true, true); 
			mi.Spawn(mapName, new Vec3f(72816.76f, 2663.238f, 1062.206f), new Vec3f(0.5446733f, 0f, -0.8386506f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_HEALTH_02"], DefaultItems.ItemInstances["ITMI_QUARTZ"]},new int[]{1, 95, 2, 2},true, DefaultItems.ItemInstances["ITKE_EVT_CRYPT_01"], null, null, "EVT_CRYPT_01_TRIGGER", true, true); 
			mi.Spawn(mapName, new Vec3f(72361.1f, 2660.929f, -1301.036f), new Vec3f(0.8386507f, 0f, 0.5446735f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_ROCKCRYSTAL"], DefaultItems.ItemInstances["ITFO_WINE"]},new int[]{28, 1, 1, 3},true, null, "LRRLRLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(62905.66f, 4278.731f, -38406.3f), new Vec3f(-0.5878179f, 8.294935E-09f, 0.8089929f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOLT"]},new int[]{10, 11},true, null, "RLLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(58694.29f, 4134.473f, -33400.75f), new Vec3f(0.9122887f, 0.02349698f, 0.4088727f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 3, 9},true, null, "LLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(59912.11f, 3879.051f, -31208.07f), new Vec3f(0.9961916f, 0f, 0.08719576f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_PLIERS"], DefaultItems.ItemInstances["ITMI_SAW"], DefaultItems.ItemInstances["ITMI_HAMMER"], DefaultItems.ItemInstances["ITMISWORDRAW"]},new int[]{1, 1, 1, 7},true, null, "LRLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(66072.34f, 3834.455f, -25002.83f), new Vec3f(-0.9902689f, 0f, -0.1391712f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_PLIERS"], DefaultItems.ItemInstances["ITMI_SAW"], DefaultItems.ItemInstances["ITMI_HAMMER"], DefaultItems.ItemInstances["ITMISWORDRAW"]},new int[]{1, 1, 1, 2},true, null, "LRLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(64203.06f, 3982.553f, -21519.15f), new Vec3f(-0.03490149f, 0f, -0.9993924f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{11},false, null, "LRRLLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(75228.87f, 3512.244f, -10401.11f), new Vec3f(0.3419827f, 0f, 0.9397056f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_2H_SLD_AXE"], DefaultItems.ItemInstances["ITMW_2H_SLD_SWORD"], DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{59, 1, 1, 26, 21},true, null, "RLLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(75304.4f, 3832.253f, -13185.37f), new Vec3f(-0.9455311f, 0f, 0.3255305f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFOMUTTONRAW"], DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITFO_CHEESE"]},new int[]{1, 2, 3},false, null, "LRRLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(70731.96f, 3151.7f, -8902.571f), new Vec3f(0.9925414f, 0f, 0.1219093f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 13, 1},true, null, "LRRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(76350.39f, 3512.384f, -10847.26f), new Vec3f(-0.9970326f, 0.01501146f, -0.07549931f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{3, 11, 1},false, null, "LLRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(75389.32f, 3514.653f, -12363.07f), new Vec3f(0.4848583f, 0.009248429f, -0.8745683f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_HEALTH_01"]},new int[]{22, 1},true, null, "LRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(76131.8f, 3513.398f, -12317.56f), new Vec3f(-0.9986264f, 0f, -0.05237531f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"], DefaultItems.ItemInstances["ITMI_PITCH"], DefaultItems.ItemInstances["ITFO_STEW"]},new int[]{5, 1, 1, 1},true, null, "RLRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(74959.43f, 3514.899f, -13521.33f), new Vec3f(-0.08671136f, -0.04126925f, 0.9953776f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_PLIERS"], DefaultItems.ItemInstances["ITMI_SAW"], DefaultItems.ItemInstances["ITMI_HAMMER"], DefaultItems.ItemInstances["ITMISWORDRAW"]},new int[]{1, 1, 1, 5},true, null, "LRLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(72568.13f, 3151.581f, -10008.7f), new Vec3f(0.0523358f, 0f, -0.9986306f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFOMUTTONRAW"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{1, 3, 4},false, null, "LRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(71227.58f, 3152.075f, -8688.286f), new Vec3f(-0.2923722f, 0f, -0.9563055f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_HEALTH_01"]},new int[]{210, 1},true, null, "LRLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(74967.64f, 3829.954f, -9473.867f), new Vec3f(-0.6156321f, 0f, -0.7880333f));

			mi = new MobContainer("CHESTBIG_NW_RICH_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_WINE"], DefaultItems.ItemInstances["ITFO_CHEESE"]},new int[]{3, 6, 3, 5},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(75945.92f, 3832.954f, -10071.08f), new Vec3f(-0.7313858f, -0.004222146f, 0.6819806f));

			mi = new MobContainer("CHESTBIG_NW_RICH_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_FISH"], DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITFO_WINE"], DefaultItems.ItemInstances["ITFO_CHEESE"]},new int[]{6, 3, 4, 2},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(75630.96f, 3830.954f, -9383.574f), new Vec3f(0.4540195f, 0f, -0.8909912f));

			mi = new MobContainer("CHESTBIG_NW_RICH_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITFO_WINE"]},new int[]{8, 2},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(75896.85f, 3831.363f, -9395.996f), new Vec3f(-0.6819768f, 0f, -0.7313735f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_SILVERCUP"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{1, 1, 30},true, DefaultItems.ItemInstances["ITKE_DEXTER"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(67499.38f, 3968.758f, -22104.74f), new Vec3f(0.52992f, 0f, 0.848049f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 23, 3},true, null, "LRRLLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(84027.9f, 4273.219f, -11226.79f), new Vec3f(0.9764391f, -0.106097f, -0.1879089f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_SWORD"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{2, 32, 1, 1, 1},true, null, "RLRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(85181.44f, 4278.219f, -10015.64f), new Vec3f(0.2367961f, -0.001901135f, 0.9715572f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 13, 1},true, null, "LRRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(86150.63f, 4279.219f, -9583.963f), new Vec3f(-0.7299767f, 0.004210358f, -0.6834594f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{20, 19},true, null, "RLLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(56622.63f, 1904.617f, -2091.319f), new Vec3f(0.2733977f, 0.0007509104f, 0.961901f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_FLASK"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITRI_MANA_01"], DefaultItems.ItemInstances["ITRU_SUMGOBSKEL"], DefaultItems.ItemInstances["ITWR_XARDASBOOKFORPYROKAR_MIS"]},new int[]{25, 1, 5, 1, 1, 1},true, DefaultItems.ItemInstances["ITKE_CHEST_SEKOB_XARDASBOOK_MIS"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(57121.37f, 1899.66f, -984.5163f), new Vec3f(-0.2413309f, 0.01191469f, -0.9703695f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITMI_QUARTZ"]},new int[]{81, 23, 2, 2},true, DefaultItems.ItemInstances["ITKE_EVT_CRYPT_03"], null, null, "EVT_CRYPT_03_TRIGGER", true, true); 
			mi.Spawn(mapName, new Vec3f(75175.91f, 2661.636f, 618.6479f), new Vec3f(-0.8290153f, 0f, -0.5592259f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_SULFUR"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 1, 1},true, null, "LLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(58644.45f, 1635.428f, 11132.61f), new Vec3f(0.866025f, 0f, -0.4999997f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_BOLT"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{23, 10, 13},true, null, "RLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(58804.2f, 1630.428f, 11224.33f), new Vec3f(-0.1736481f, 0f, -0.9848074f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOLT"]},new int[]{10, 17},true, null, "RLLRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(45545.21f, 3039.665f, 3433.785f), new Vec3f(-0.9876882f, 0f, 0.1564346f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_ROCKCRYSTAL"], DefaultItems.ItemInstances["ITFOMUTTONRAW"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{1, 1, 1},true, null, "LRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(45308.33f, 3041f, 3676.858f), new Vec3f(-0.06975654f, 0f, -0.9975638f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUM.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{20, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(81738.89f, 4150.927f, -19413.7f), new Vec3f(0.978148f, 0f, -0.2079118f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUM.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"], DefaultItems.ItemInstances["ITMI_SULFUR"]},new int[]{3, 9, 1, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(70172.66f, 1682.492f, -24365f), new Vec3f(0.2419221f, 0f, 0.9702958f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_ROCKCRYSTAL"], DefaultItems.ItemInstances["ITFO_WINE"]},new int[]{8, 1, 1, 1},true, null, "LRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(70335.11f, 1675.708f, -24400.72f), new Vec3f(0f, 0f, 1f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_HEALTH_01"]},new int[]{6, 10, 1},true, null, "LRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(48925.22f, 1300.37f, 6317.779f), new Vec3f(0.9848076f, 0f, 0.1736481f));

			mi = new MobContainer("CHESTBIG_OCCHESTMEDIUMLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_SLD_AXE"], DefaultItems.ItemInstances["ITMI_PITCH"], DefaultItems.ItemInstances["ITFO_CHEESE"]},new int[]{17, 1, 1, 1},true, null, "RRLRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(48794.14f, 1285.37f, 6554.041f), new Vec3f(0.9848073f, 0f, 0.1736481f));

			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITMI_PITCH"], DefaultItems.ItemInstances["ITMW_1H_VLK_MACE"]},new int[]{35, 1, 1, 1},true, null, "LRLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(58960.91f, 1883.875f, -29030.11f), new Vec3f(-0.5f, 0f, 0.8660253f));

			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{38},true, null, "LLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(58719.45f, 1893.875f, -29087.05f), new Vec3f(0f, 0f, 1f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{3, 26, 1},true, null, "LRRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(51821.21f, 4990.391f, 19097.85f), new Vec3f(-0.6560584f, 0f, -0.7547107f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{3, 26, 1},true, null, "RLRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(51511.95f, 4990.391f, 19639.13f), new Vec3f(-0.8746197f, 0f, -0.4848112f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_MANA_03"], DefaultItems.ItemInstances["ITSC_SUMSKEL"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITSC_CHARGEFIREBALL"]},new int[]{3, 1, 42, 3},true, null, "RLLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(49417.79f, 4991.992f, 21210.12f), new Vec3f(0f, 0f, 1f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{45},true, null, "LRLLRRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(50262.59f, 4992.913f, 21728.86f), new Vec3f(-0.984808f, 0f, 0.1736483f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_MANA_02"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{3, 26, 1},false, null, "RRLL", null, null, true, true); 
			...
			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_SCHAFSWURST"]},new int[]{14},false, null, null, null, null, true, true); 
			...
			mi = new MobContainer("CHESTSMALL_OCCHESTSMALLLOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{20, 1},true, null, "LR", null, null, true, true); 
			...
			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_03"], DefaultItems.ItemInstances["ITPO_MANA_03"], DefaultItems.ItemInstances["ITMI_QUARTZ"], DefaultItems.ItemInstances["ITFO_BOOZE"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_SULFUR"]},new int[]{2, 3, 1, 1, 400, 1},false, null, "RLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(47616.48f, 3475.854f, 16584.18f), new Vec3f(0.1045288f, 0f, 0.9945229f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_JEWELERYCHEST"], DefaultItems.ItemInstances["ITMI_GOLDRING"], DefaultItems.ItemInstances["ITMI_GOLDCUP"], DefaultItems.ItemInstances["ITMI_GOLDPLATE"], DefaultItems.ItemInstances["ITMI_SULFUR"]},new int[]{1, 1, 1, 1, 5},true, null, "RLRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(49616.32f, 4241.308f, 18210.44f), new Vec3f(0.4539909f, 0f, 0.8910069f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_SULFUR"]},new int[]{350, 1},true, null, "RLRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(49510.55f, 4238.308f, 18429.29f), new Vec3f(0.9925459f, 0f, -0.1218703f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITSC_TRFWOLF"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{2, 2, 32},false, null, "LRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(48152.47f, 4995.622f, 22353.8f), new Vec3f(0.5135404f, 0f, -0.8580636f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_SULFUR"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{21, 1, 1, 1},true, null, "LLRR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(47481.58f, 4995.788f, 21581.76f), new Vec3f(0.9593117f, 0f, -0.2823403f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_IGARAZ", new ItemInstance[]{DefaultItems.ItemInstances["ITWR_BABOSDOCS_MIS"]},new int[]{1},true, DefaultItems.ItemInstances["ITKE_IGARAZCHEST_MIS"], null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(48007.7f, 4989.755f, 21736.91f), new Vec3f(-0.7241709f, 0f, -0.6896202f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_HONEY"], DefaultItems.ItemInstances["ITFO_BREAD"], DefaultItems.ItemInstances["ITFO_SAUSAGE"]},new int[]{3, 5, 10},true, null, "LRLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(51327.77f, 4243.015f, 19805.39f), new Vec3f(-0.8480473f, 0f, -0.52992f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{1, 20, 1},true, null, "LRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(36504.19f, 4680.061f, -38162.44f), new Vec3f(0f, 0f, 1f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_02"], DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{2, 25},true, null, "RLRL", null, null, true, true); 
			...
			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_QUARTZ"]},new int[]{111, 23, 1, 1},true, null, "LRRLRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(82987.7f, 3547.792f, 22025.21f), new Vec3f(-0.4999993f, 0f, 0.8660246f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{55},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(60720.14f, 7086.126f, 24873.06f), new Vec3f(-0.5446404f, 0f, -0.83867f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{25, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(60576.73f, 7086.466f, 24902.72f), new Vec3f(-0.0697564f, 0f, -0.9975648f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_BOW_L_03"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMI_SULFUR"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 1, 1, 1},true, null, "LLRRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(56935.32f, 6932.794f, 25788.09f), new Vec3f(0.1218695f, 0f, -0.992547f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMW_MORGENSTERN"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITSE_GOLEMCHEST_MIS"]},new int[]{1, 150, 1},true, null, "LLRRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(84871.34f, 5451.599f, 33451.47f), new Vec3f(-0.9876892f, 0f, -0.1564338f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_ROCKCRYSTAL"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{1, 1, 1},true, null, "LRRRL", null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(34849.65f, 5059.265f, 31437.37f), new Vec3f(0.7986363f, 0f, -0.6018159f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMI_ROCKCRYSTAL"], DefaultItems.ItemInstances["ITFOMUTTON"], DefaultItems.ItemInstances["ITFO_BOOZE"]},new int[]{150, 1, 1, 1},true, null, "LRRRL", null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(37788.73f, 5410.367f, 32117.73f), new Vec3f(-0.9563596f, -0.01091232f, -0.2919949f));

			mi = new MobContainer("CHESTBIG_NW_RICH_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_RUNEBLANK"]},new int[]{1},true, DefaultItems.ItemInstances["ITKE_MAGICCHEST"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(66055.4f, 6712.728f, 46370.94f), new Vec3f(-0.7431452f, 0f, -0.6691309f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRI_PROT_FIRE_02"], DefaultItems.ItemInstances["ITFO_FISH"]},new int[]{1, 1},true, null, "LRLRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(73994.27f, 5491.545f, 23710.38f), new Vec3f(-0.8386706f, 0f, 0.544639f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{11},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(79082.98f, 5479.306f, 34039.04f), new Vec3f(0.8660265f, 0f, 0.5000007f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{32, 1},false, null, "LRLLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(79042.31f, 5475.306f, 34133f), new Vec3f(0.9961962f, 0f, 0.08715593f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{100, 7},true, null, "RLLRLR", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(81407.68f, 5432.512f, 34724.04f), new Vec3f(0.1736487f, 0f, -0.9848092f));

			mi = new MobContainer("CHESTBIG_OCCHESTLARGELOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMW_ORKSCHLAECHTER"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_ARROW"]},new int[]{1, 120, 17},true, null, "RLLRRRL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(74465.47f, 6678.921f, 28941.58f), new Vec3f(0.1736481f, 0f, -0.9848074f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITSC_LIGHTHEAL"], DefaultItems.ItemInstances["ITSC_INSTANTFIREBALL"]},new int[]{20, 1, 1},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(30045.9f, 5147.116f, -16555.56f), new Vec3f(-0.6944947f, 0f, 0.7194987f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITSC_LIGHT"], DefaultItems.ItemInstances["ITKE_LOCKPICK"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{5, 1, 2, 1},true, DefaultItems.ItemInstances["ITKE_XARDAS"], "LRLL", null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(29465.3f, 5893.728f, -15319.75f), new Vec3f(0.9133196f, 0f, -0.4072479f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITPO_HEALTH_01"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{1, 5, 1},false, null, null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(24472.27f, 3109.886f, -21075.66f), new Vec3f(0.636488f, 0f, -0.7712862f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_LOCKED.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITRW_ARROW"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITRW_BOW_L_01"]},new int[]{15, 29, 1},true, DefaultItems.ItemInstances["ITKE_BANDIT"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(17897.08f, 3163.391f, -20770.13f), new Vec3f(-0.6664597f, 0.007859284f, -0.7455016f));

			mi = new MobContainer("CHESTBIG_NW_NORMAL_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITLSTORCH"], DefaultItems.ItemInstances["ITMI_GOLD"], DefaultItems.ItemInstances["ITSC_LIGHTHEAL"], DefaultItems.ItemInstances["ITSC_INSTANTFIREBALL"]},new int[]{1, 10, 1, 2},false, null, null, null, null, true, true); 
			mi.Spawn(mapName, new Vec3f(29897.81f, 4248.067f, -14872.52f), new Vec3f(0.7661476f, 0.01090523f, 0.6425769f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITFO_APPLE"], DefaultItems.ItemInstances["ITPO_MANA_01"], DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"]},new int[]{1, 1, 1},false, null, null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(33911.71f, 3649.859f, -20389.39f), new Vec3f(0.2159216f, 0f, 0.976413f));

			mi = new MobContainer("CHESTSMALL_NW_POOR_OPEN.MDS", "MOBNAME_CHEST", new ItemInstance[]{DefaultItems.ItemInstances["ITMI_GOLD"]},new int[]{35},false, null, null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_POOR_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_THIEFGUILDKEY_HOTEL_MIS"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_CITY_TOWER_04"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(10678.06f, 268.8279f, 5057.788f), new Vec3f(-0.829038f, 0f, -0.559193f));

			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_CITY_TOWER_03"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_CITY_TOWER_01"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(8827f, 269f, -6082f), new Vec3f(0.1391733f, 0f, 0.9902686f));

			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_CITY_TOWER_02"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(7319f, 270f, -5884f), new Vec3f(-0.136235f, 0f, -0.9906811f));

			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_CITY_TOWER_06"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(5245.266f, 190.9999f, -2877.972f), new Vec3f(0.4817551f, 0f, -0.8763093f));

			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_CITY_TOWER_05"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "", true, DefaultItems.ItemInstances["ITKE_THIEFGUILDKEY_MIS"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_POOR_01.MDS", "", true, DefaultItems.ItemInstances["ITKE_FINGERS"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_POOR_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_BROMOR"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_NORMAL_01.MDS", "", true, DefaultItems.ItemInstances["ITKE_ORLAN_HOTELZIMMER"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_POOR_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_ORLAN_TELEPORTSTATION"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_RICH_01.MDS", "", true, DefaultItems.ItemInstances["ITKE_KDFPLAYER"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(50380.18f, 4978.516f, 18681.87f), new Vec3f(-0.5299211f, 0f, 0.8480482f));

			mi = new MobDoor("DOOR_NW_RICH_01.MDS", "MOBNAME_VORRATSKAMMER", true, DefaultItems.ItemInstances["ITKE_KLOSTERSTORE"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(50316.17f, 4235.498f, 19384.27f), new Vec3f(0.8480474f, 0f, 0.5299203f));

			mi = new MobDoor("DOOR_NW_DRAGONISLE_02.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_MONASTARYSECRETLIBRARY_MIS"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(47889.15f, 3456.856f, 19338.17f), new Vec3f(0.4848112f, -1.299319E-10f, -0.8746201f));

			mi = new MobDoor("DOOR_NW_RICH_01.MDS", "MOBNAME_Door", true, DefaultItems.ItemInstances["ITKE_INNOS_MIS"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_RICH_01.MDS", "MOBNAME_BIBLIOTHEK", true, DefaultItems.ItemInstances["ITKE_KLOSTERBIBLIOTHEK"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(46604.68f, 4988.83f, 20189.71f), new Vec3f(0.8290369f, 0f, 0.5591939f));

			mi = new MobDoor("DOOR_NW_RICH_01.MDS", "MOBNAME_SCHATZKAMMER", true, DefaultItems.ItemInstances["ITKE_KLOSTERSCHATZ"], null, null, null, true, false); 
			mi.Spawn(mapName, new Vec3f(49838.6f, 4238.091f, 18897.59f), new Vec3f(-0.54464f, 0f, 0.8386697f));

			mi = new MobDoor("DOOR_NW_POOR_01.MDS", "MOBNAME_DOOR", true, DefaultItems.ItemInstances["ITKE_PASS_MIS"], null, null, null, true, false); 
			...
			mi = new MobDoor("DOOR_NW_RICH_01.MDS", "", true, DefaultItems.ItemInstances["ITKE_SHIP_LEVELCHANGE_MIS"], null, null, null, true, false); 
