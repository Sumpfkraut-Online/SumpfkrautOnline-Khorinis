...
namespace GUC.Server.Scripts
{
	public class DefaultWorldItem
	{
		public static void Init()
		{
			...
			mi = new Item(DefaultItems.ItemInstances["ITSE_GOLDPOCKET100"], 1);
			mi.Spawn(mapName, new Vec3f(840.4073f, -63.2526f, 23274.86f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITPL_TEMP_HERB"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_SCHWERT3"], 1);
			mi.Spawn(mapName, new Vec3f(786.5247f, 0.310257f, 23301.94f), new Vec3f(-0.9332727f, -0.138968f, 0.331193f));

			mi = new Item(DefaultItems.ItemInstances["ITMW_PIRATENSAEBEL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_FISH"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_ARROW"], 1);
			mi.Spawn(mapName, new Vec3f(-13967.49f, -219.2036f, -8651.255f), new Vec3f(-0.8571675f, 1.16711E-10f, 0.5150378f));

			mi = new Item(DefaultItems.ItemInstances["ITRW_BOLT"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_MISC_SWORD"], 1);
			mi.Spawn(mapName, new Vec3f(-14447.37f, -218.0319f, -8545.304f), new Vec3f(0.8480481f, 3.132457E-16f, 0.5299193f));

			mi = new Item(DefaultItems.ItemInstances["ITMI_OLDCOIN"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_SAW"], 1);
			mi.Spawn(mapName, new Vec3f(-13876.14f, -217.4076f, -9241.297f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITMI_NUGGET"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFOMUTTONRAW"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_WINE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_FISHSOUP"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_FLASK"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_GOLDCUP"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_SAUSAGE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_BACON"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_VLK_DAGGER"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_CHEESE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_BEER"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_PAN"], 1);
			mi.Spawn(mapName, new Vec3f(10930.21f, 1010.249f, 973.5448f), new Vec3f(-0.8829484f, 0f, 0.469472f));

			mi = new Item(DefaultItems.ItemInstances["ITMI_BROOM"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPO_HEALTH_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_PLIERS"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITFO_STEW"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_VLK_AXE"], 1);
			mi.Spawn(mapName, new Vec3f(4574.66f, -60.93961f, 768.3463f), new Vec3f(-0.5247632f, 0.851252f, -0.0004423326f));

			mi = new Item(DefaultItems.ItemInstances["ITFOMUTTON"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_BLOODCUP_MIS"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_BOW_L_01"], 1);
			mi.Spawn(mapName, new Vec3f(58.22722f, 305.7227f, -21896.48f), new Vec3f(0.8191532f, 0f, 0.573576f));

			mi = new Item(DefaultItems.ItemInstances["ITSC_INSTANTFIREBALL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_HEALTH_HERB_01"], 1);
			mi.Spawn(mapName, new Vec3f(-2797.596f, 443.2443f, -14250.07f), new Vec3f(0.01354553f, 0.2266656f, 0.9738786f));

			mi = new Item(DefaultItems.ItemInstances["ITPL_MUSHROOM_01"], 1);
			mi.Spawn(mapName, new Vec3f(-2760.104f, 432.0842f, -14496.67f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITPL_MANA_HERB_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_MANA_HERB_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_HEALTH_HERB_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_MUSHROOM_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_BLUEPLANT"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMISWORDRAW"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITAT_SHEEPFUR"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_PLANEBERRY"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_FORESTBERRY"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_LIGHTHEAL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_2H_AXE_L_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_PYROKINESIS"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPO_HEALTH_03"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_SHORTSWORD4"], 1);
			mi.Spawn(mapName, new Vec3f(32482.69f, 3545.061f, 472.7037f), new Vec3f(0.2325069f, 0.273468f, -0.9333567f));

			mi = new Item(DefaultItems.ItemInstances["ITPL_DEX_HERB_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_STRENGTH_HERB_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_PERM_HERB"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_HEALTH_HERB_03"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRI_PROT_MAGE_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_MANA_HERB_03"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRI_MANA_02"], 1);
			mi.Spawn(mapName, new Vec3f(16747.51f, 5106.001f, 8729.516f), new Vec3f(0f, 0.2079117f, 0.9781479f));

			mi = new Item(DefaultItems.ItemInstances["ITSC_HARMUNDEAD"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_FIRESTORM"], 1);
			mi.Spawn(mapName, new Vec3f(16736.2f, 5109.531f, 8618.063f), new Vec3f(-0.9796002f, 0.1708735f, 0.1057657f));

			mi = new Item(DefaultItems.ItemInstances["ITSC_MEDIUMHEAL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_CROSSBOW_L_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRI_STR_01"], 1);
			mi.Spawn(mapName, new Vec3f(19050.26f, 1840.429f, 4551.808f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITRI_PROT_EDGE_01"], 1);
			mi.Spawn(mapName, new Vec3f(19033.58f, 1838.532f, 4560.503f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITMW_SHORTSWORD1"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_FIREBOLT"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_2H_ORCAXE_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPO_MANA_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_JEWELERYCHEST"], 1);
			mi.Spawn(mapName, new Vec3f(31214.4f, 4205.167f, -12513.17f), new Vec3f(0f, 0.06975648f, 0.9975641f));

			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_PAL_SWORD"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_2H_PAL_SWORD"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_BOW_L_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_COAL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_MACE_L_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_COMMON_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_POCKET"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITAT_WOLFFUR"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_SUMGOBSKEL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_AQUAMARINE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_SWAMPHERB"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPL_SPEED_HERB_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_CROSSBOW_L_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_STOMPER"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_STREITKOLBEN"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_ADDON_FIREARROW"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_ADDON_FIREBOW"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_FULLHEAL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_GOLDRING"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_ROCKCRYSTAL"], 1);
			mi.Spawn(mapName, new Vec3f(62454.91f, 1835.759f, 7924.486f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITWR_KRYPTA_GARON"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_NAGELKEULE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITAT_SHADOWFUR"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_NAGELKNUEPPEL"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_MIL_SWORD"], 1);
			mi.Spawn(mapName, new Vec3f(80383.44f, 4182.672f, -13758.79f), new Vec3f(-0.1152084f, -0.3583344f, -0.9264584f));

			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_SLD_AXE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_2H_BAU_AXE"], 1);
			mi.Spawn(mapName, new Vec3f(50415.7f, 1297.638f, 5808.695f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITMW_STABKEULE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_RAPIER"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_BAU_MACE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_SPICKER"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_SILVERCANDLEHOLDER"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITAT_LURKERSKIN"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITAT_WARGFUR"], 1);
			...
			//mi = new Item(DefaultItems.ItemInstances["HOLY_HAMMER_MIS"], 1);
			//mi.Spawn(mapName, new Vec3f(45998.67f, 4337.971f, 19613.93f), new Vec3f(-0.06974585f, -0.01745241f, 0.9974123f));

			mi = new Item(DefaultItems.ItemInstances["ITPL_WEED"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_GOLDPLATE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRU_LIGHTHEAL"], 1);
			mi.Spawn(mapName, new Vec3f(31569.68f, 4609.338f, -41314.73f), new Vec3f(0f, 0f, 1f));

			mi = new Item(DefaultItems.ItemInstances["ITSC_TRFGIANTBUG"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITRW_CROSSBOW_M_01"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_SLEEP"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_LIGHT"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_ZWEIHAENDER1"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITPO_MANA_03"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_1H_SLD_SWORD"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_2H_ORCAXE_02"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_GOLDCHEST"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_2H_SLD_SWORD"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_DRACHENSCHNEIDE"], 1);
			mi.Spawn(mapName, new Vec3f(46696.18f, 7916f, 35464.57f), new Vec3f(-0.2144265f, 0.003590923f, 0.9767239f));
			...
			mi = new Item(DefaultItems.ItemInstances["ITMI_SILVERCHALICE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITSC_ICECUBE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_FOLTERAXT"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_KRIEGSKEULE"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_SCHWERT2"], 1);
			...
			mi = new Item(DefaultItems.ItemInstances["ITMW_ZWEIHAENDER2"], 1);
			mi.Spawn(mapName, new Vec3f(35889.96f, 5490.744f, 32870.28f), new Vec3f(-0.807766f, 0.05028389f, -0.5873535f));

			mi = new Item(DefaultItems.ItemInstances["ITRI_PROT_POINT_02"], 1);
